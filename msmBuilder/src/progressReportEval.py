...
def trainAgent():
        ...
        thisoutput1 = (results1,times1)
        f1 = open('random'+str(episodesToRun)+'.dat','w')
        pickle.dump(thisoutput1,f1)

        thisoutput2 = (results2,times2)
        f2 = open('qnn'+str(episodesToRun)+'.dat','w')
        pickle.dump(thisoutput2,f2)
